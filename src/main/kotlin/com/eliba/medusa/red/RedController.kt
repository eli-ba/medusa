...
class RedController {
    ...
    fun generate(
        ...
        val materializedViews = MaterializedViewGenerator(materializedViewCount, tables).generate()
        ...
        materializedViews.forEachIndexed { index, element ->
            sql.append(element.render(renderOptions))
